...
*/
typedef CvMat* (*RansacXFormFUNC)(CvPoint2D32f* pts, CvPoint2D32f* mpts, int n);
...
*/
typedef double (*RansacErrFUNC)(CvPoint2D32f pt, CvPoint2D32f mpt, CvMat* T);
...
*/
extern CvMat* RansacXForm(const std::vector<util::pair>& pairs, RansacXFormFUNC xform_fn,
...
/**
   ...
   linear transform.  Intended for use as a RansacXFormFUNC.
...
*/
extern CvMat* dlt_homog(CvPoint2D32f* pts, CvPoint2D32f* mpts, int n);


/**
   Calculates a least-squares planar homography from point correspondeces.
   Intended for use as a RansacXFormFUNC.
