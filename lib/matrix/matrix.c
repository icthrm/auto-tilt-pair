...
void matrix_power(int n, const double *A, int pow, double *R)
{
    int i;
...
void matrix_diff(int Am, int An, int Bm, int Bn, const double *A, const double *B, double *R) {
    int r = Am;
    int c = An;
    int n = r * c, i;
...
void matrix_product33(const double *A, const double *B, double *R)
{
...
void matrix_product44(const double *A, const double *B, double *R)
{
...
void matrix_product121(const double *A, const double *b, double *r)
{
    r[0] = A[0] * b[0] + A[1] * b[1];
}

void matrix_product131(const double *A, const double *b, double *r)
{
    r[0] = A[0] * b[0] + A[1] * b[1] + A[2] * b[2];
}

void matrix_product331(const double *A, const double *b, double *r)
{
    r[0] = A[0] * b[0] + A[1] * b[1] + A[2] * b[2];
...
void matrix_product341(const double *A, const double *b, double *r)
{
...
void matrix_product441(const double *A, const double *b, double *r)
{
    r[0] = A[0] * b[0] + A[1] * b[1] + A[2] * b[2] + A[3] * b[3];
    r[1] = A[4] * b[0] + A[5] * b[1] + A[6] * b[2] + A[7] * b[3];
    r[2] = A[8] * b[0] + A[9] * b[1] + A[10] * b[2] + A[11] * b[3];
...
void matrix_transpose_product(int Am, int An, int Bm, int Bn, const double *A, const double *B, double *R) {
    int r = An;
    int c = Bn;
    int m = Am;
...
/* Compute the matrix product R = A B^T */
void matrix_transpose_product2(int Am, int An, int Bm, int Bn, const double *A, const double *B, double *R) {
    int r = Am;
    int c = Bm;
    int m = An;
...
void gelss_driver(double *A, double *b, double *x, int m, int n, int nrhs) {
    if (m < n) {
...
void matrix_lu(int n, const double *A, double *LU, int *ipiv)
{
...
/* Compute (transpose of) LU decomposition of A */
void matrix_lu_no_transpose(int n, const double *A, double *LU, int *ipiv)
{
    double *Atmp = malloc(sizeof(double) * n * n);
    int m = n;
    int lda = n;
...
double matrix_determinant2(const double *A)
{
    /* 0 1
     * 2 3*/
...
double matrix_determinant3(const double *A)
{
#if 0
...
double matrix_norm(int m, int n, const double *A) {
    double sum = 0.0;
    int i;
    int entries = m * n;
...
double matrix_normsq(int m, int n, const double *A) 
{
    double sum = 0.0;
    int i;
    int entries = m * n;
...
void matrix_scale(int m, int n, const double *A, double s, double *R) {
    int i;
    int entries = m * n;
...
void matrix_print(int m, int n, const double *A) {
    int i, j;
...
void matrix_read_file(int m, int n, double *matrix, const char *fname) {
...
void matrix_write_file(int m, int n, const double *matrix, const char *fname) {
